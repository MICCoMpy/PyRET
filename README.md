# Welcome to the Github Page of Py-RET
...
# Installation
Before the installation, make sure that wavefunctions can be extracted parallely from hdf5 files, h5py is compiled with parallel support.
